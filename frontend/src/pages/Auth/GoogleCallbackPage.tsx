...
const GoogleCallbackPage = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[rgb(8_27_46)]">
      <LoginHeader />
      <main className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="grid w-full max-w-6xl gap-10 lg:grid-cols-2">
          ...
          <section className="flex items-center justify-center">
            <div className="w-full max-w-[480px] rounded-[18px] bg-[rgb(15_35_56/0.9)] p-9 shadow-[0_30px_60px_rgb(5_9_20/0.45)]">
              {error ? (
                <>
                  <div>
                  ...
                  <button
                    type="button"
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 px-4 py-4 text-base font-semibold text-white transition hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgb(var(--brand-blue)/0.4)]"
                ...
                <div className="mt-2 flex min-h-[140px] flex-col items-center justify-center gap-3 text-[rgb(var(--landing-text-soft))]">
