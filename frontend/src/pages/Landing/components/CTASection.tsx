  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[rgb(var(--landing-bg-base))] via-[rgb(var(--landing-bg-mid))] to-[rgb(var(--landing-bg-end))] px-[5%] py-24 text-center">
      ...
      <div className="relative mx-auto max-w-[760px]">
        ...
        <p className="mb-8 text-[1.2rem] leading-relaxed text-[rgb(var(--landing-text-soft))]">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <button
            type="button"
            className="inline-flex items-center justify-center rounded-full bg-gradient-to-br from-[rgb(var(--brand-blue))] to-[rgb(var(--brand-blue-deep))] px-7 py-3 font-semibold text-white shadow-[0_8px_30px_rgb(var(--brand-blue)/0.35)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_30px_rgb(var(--brand-blue)/0.5)]"
