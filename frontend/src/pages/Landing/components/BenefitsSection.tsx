    ...
    >
      ...
      <div className="relative mx-auto grid max-w-[1200px] grid-cols-[repeat(auto-fit,minmax(280px,1fr))] items-center gap-12">
        <div
          ...
          aria-hidden="true"
        >
          <div className="absolute inset-0 bg-[linear-gradient(rgb(255_255_255/0.05)_1px,transparent_1px),linear-gradient(90deg,rgb(255_255_255/0.05)_1px,transparent_1px)] bg-[length:40px_40px] opacity-60" />
        ...
        <div>
          ...
          {benefits.map((benefit) => (
            <article
              key={benefit.title}
              className="mb-3.5 flex items-start gap-4 rounded-2xl border border-[rgb(var(--brand-blue)/0.1)] bg-[rgb(255_255_255/0.02)] p-5 transition duration-300 hover:translate-x-2 hover:border-[rgb(var(--brand-blue))] hover:shadow-[0_20px_45px_rgb(var(--brand-blue)/0.18)]"
            >
              <div className="flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-[14px] border border-[rgb(255_255_255/0.08)] bg-gradient-to-br from-[rgb(var(--brand-blue))] to-[rgb(var(--brand-blue-deep))] text-[rgb(236_240_255/0.98)] shadow-[0_10px_22px_rgb(var(--brand-blue)/0.22)]">
